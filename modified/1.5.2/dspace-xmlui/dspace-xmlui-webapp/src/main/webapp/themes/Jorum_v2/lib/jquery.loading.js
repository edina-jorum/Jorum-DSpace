...
//Seems a bit flaky and takes a good while to appear otherwise
$(document).ready(function(){
	 image1 = $('<img />').attr('src', '/xmlui/themes/Jorum_v2/images/ajax-loader.gif');		      
});
...
;(function($) {
    ...
    $.extend(L, {
        ...
        pulse: null,
        mask: false,
        img: '/xmlui/themes/Jorum_v2/images/ajax-loader.gif',
        element: null,
        text: 'Loading...',
        onAjax: undefined,
        delay: 0,
        ...
        cloneEvents: true,
        pageOptions: { page:true, align:'top-right', css:fixed, maskCss:fixed},
        // rarely-used options
        html: '<div></div>',
        maskHtml: '<div></div>',
